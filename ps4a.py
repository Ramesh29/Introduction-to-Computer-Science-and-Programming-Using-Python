...
def getWordScore(word, n):
    ...
    wordlist = list(word)
    for l in wordlist:
        score = score + SCRABBLE_LETTER_VALUES.get(l)
    
    # multiply the the length of the word
...
def isValidWord(word, hand, wordList):
    ...
    hand_copy = hand.copy()
    for l in word:
        if l not in hand_copy:
            return False
        elif hand_copy.get(l) == 0:
            return False
        else:
            hand_copy[l] = hand_copy[l] - 1
    ...
    * The hand finishes when there are no more unused letters or the user
    ...
    while calculateHandlen(hand) > 0:
        ...
        if word.strip() == ".":
            ...
            print("Goodbye! Total: " + str(score) + " points.")
            break
